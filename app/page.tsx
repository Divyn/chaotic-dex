...
const EVENT_TEMPLATES: Omit<ChaosEvent, 'id'>[] = [
  ...
  { text: "a golden retriever was appointed market maker — markets rally on vibes", pert: 0.06 },
  ...
  { text: "mathematics declared legally ungovernable — regulators in shambles", pert: 0.03 },
...
const NEWS_HEADLINES = [
  ...
  "Central Banks Consider Switching to Logistic Map Standard",
